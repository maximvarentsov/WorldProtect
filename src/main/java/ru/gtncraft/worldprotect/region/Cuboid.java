...
public class Cuboid implements Iterable<Block>, Cloneable, ConfigurationSerializable {
     ...
     *
     * @param world - The Cuboid's world name
     * @param x1 - X co-ordinate of corner 1
     * @param y1 - Y co-ordinate of corner 1
     * @param z1 - Z co-ordinate of corner 1
     * @param x2 - X co-ordinate of corner 2
     ...
     * @param z2 - Z co-ordinate of corner 2
     */
    private Cuboid(final String world, final int x1, final int y1, final int z1, final int x2, final int y2, final int z2) {
    ...
    public Collection<Block> getBlocks() {
        final Iterator<Block> it = this.iterator();
        final Collection<Block> copy = new ArrayList<>();
        while (it.hasNext()) {
            copy.add(it.next());
        }
        return copy;
    ...
    public Cuboid outset(final CuboidDirection dir, final int amount) {
        ...
        switch (dir) {
            case Horizontal:
                cuboid = expand(CuboidDirection.North, amount).expand(CuboidDirection.South, amount).expand(CuboidDirection.East, amount).expand(CuboidDirection.West, amount);
                break;
            case Vertical:
